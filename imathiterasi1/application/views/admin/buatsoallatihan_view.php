<html>
    ...
    <div class="container contents">
		...
		<label>Pertanyaan</label></br><textarea name ="pertanyaan"></textarea></br>
		<input type="file" name="gambarSoal" id="gambarSoal" size="20" /></br></br>
		<label>A.  </label><input type="text" name ="optiona"></br>	
		<input type="file" name="gambara" id="gambara" size="20" /></br></br>
		<label>B.  </label><input type="text" name ="optionb"></br>
		<input type="file" name="gambarb" id="gambarb" size="20" /></br></br>
		<label>C.  </label><input type="text" name ="optionc"></br>
		<input type="file" name="gambarc" id="gambarc" size="20" /></br></br>
		<label>D.  </label><input type="text" name ="optiond"></br>
		...
		<label>Pembahasan</label></br><textarea name ="pembahasan"></textarea></br></br>
