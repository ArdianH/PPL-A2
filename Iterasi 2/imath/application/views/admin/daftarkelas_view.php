<html>
	...
	$(document).ready(function(){
		//$("#pilihmateri").change(function(){
			...
			var location = baseUrl + "/index.php/kelas/hasil/" + $("#idKelas").val();
    	...
    	<table class="table table-hover table-striped tableimath">
	        ...
	        <tbody>
	        	...
	        	<tr>	
					...
					<td class="col-md-3">
					<a href="<?php echo base_url();?>index.php/admin/daftar_kunjungan/viewKunjungan/<?php echo $result[$i]['idKelas'] ?>">
					
					<p><?php echo $jumlahPengunjung[$result[$i]['idKelas']]; ?></p>				
