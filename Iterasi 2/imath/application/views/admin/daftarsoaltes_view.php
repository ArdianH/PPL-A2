    ...
    <body>
      ...
      <div class="row">
        <div class="container" id="iconbar">
          ...
          <div class="col-md-2"><a href="<?php echo base_url();?>index.php/admin/soal_tes"><p>Soal Latihan</p></a></div>
          <div class="col-md-2"><a href="<?php echo base_url();?>index.php/admin/soal_tes"><p>Soal Tes</p></a></div> 
