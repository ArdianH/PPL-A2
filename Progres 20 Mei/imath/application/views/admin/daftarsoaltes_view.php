...
<!--========================== ADMIN NAVBAR ============================-->
 ...
 <!--======================= END OF ADMIN NAVBAR ============================-->
  ...
  <div class="row">
    ...
    <div class="col-md-3">
    <?php if($isViewed == 'true'){ ?>
	<a href=" <?php echo base_url();?>admin/soal_tes/createview/<?php echo $currentkelas[0]->idKelas?>"><button class="adminBiruButton"> Buat Baru</button></a>
	<?php }?>
    </div>
    <div class="col-md-3">
      <?php if($isViewed == "true"){
    ...
    <td>
      <a href="<?php echo base_url();?>admin/soal_tes/detail/<?php echo $row->idSoal ?>">
                                              <img src="<?php echo base_url() ?>assets/images/info.png" width="50px" height="50px"></a>
            <!-- Edit Button-->
            <a href="<?php echo base_url();?>admin/soal_tes/edit/<?php echo $row->idSoal ?>">
