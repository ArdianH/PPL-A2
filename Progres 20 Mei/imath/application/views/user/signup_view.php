...
<body>
	...
	<form class="formImath anggotaLogin" method="POST" action= <?php echo base_url()."autentikasi/process_signup/" ?> >
		<div class="row">
			...
			<div class="col-md-8"><input class="noBorder" type="text" name="username" size="50" title="Username harus valid (2-25 alphanumeric, tanpa spasi)" pattern="^[a-zA-Z][a-zA-Z0-9-_\.]{1,24}$" required>
			</div>
		</div>
		<div class="row">
