...
<div class="container">
	...
	<div class="contentsKebijakanPrivasi" align="center">
		<h1 id="tulisanBiru" class="weight">Kebijakan Privasi</h1>
		</br>
		<form class="formImath" method="POST" action="<?php echo base_url(); ?>admin/lain_lain/processKebijakanPrivasi/" enctype="multipart/form-data" >
			<div align="center">
