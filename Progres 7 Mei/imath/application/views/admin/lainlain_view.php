	...
	<table class="table table-hover table-striped tableimath">
		...
		<tbody>
			<tr>
				...
				<td>
					<!-- Edit Button-->
					<a href="<?php echo base_url();?>index.php/admin/lain_lain/bantuan">
			...
			<tr>
				...
				<td>
					<!-- Edit Button-->
					<a href="<?php echo base_url();?>index.php/admin/lain_lain/tentang_kami">
						      <img src="<?php echo base_url() ?>assets/images/editicon.png" width="50px" height="50px"></a>
				</td><td></td>
			</tr>
			<tr>
				...
				<td>
					<!-- Edit Button-->
					<a href="<?php echo base_url();?>index.php/admin/lain_lain/kebijakan_privasi">
						      <img src="<?php echo base_url() ?>assets/images/editicon.png" width="50px" height="50px"></a>
				</td><td></td>
			</tr>      
		</tbody>
